...
function BlockShape({ b, bounds }: { b: Block; bounds: MapBounds }) {
  ...
  const stroke = 'rgba(14,17,22,0.14)'
  ...
  if (b.round) {
    ...
    return (
      <g>
        <ellipse cx={cx} cy={baseY} rx={w / 2} ry={d / 2} fill={tone.front} stroke={stroke} strokeWidth={0.6} />
        ...
        <ellipse cx={cx} cy={topY} rx={w / 2} ry={d / 2} fill={tone.top} stroke={stroke} strokeWidth={0.6} />
      </g>
    )
  }
    ...
    <g>
      <defs>
        <pattern id="home-plank" width="96" height="24" patternUnits="userSpaceOnUse">
          <rect width="30" height="12" fill="#e9ecf0" />
          <rect x="30" width="66" height="12" fill="#f0f2f5" />
          <rect y="12" width="78" height="12" fill="#eceff3" />
          <rect x="78" y="12" width="18" height="12" fill="#e4e8ed" />
          <path
            d="M0 12H96M0 24H96M30 0V12M78 12V24"
            stroke="rgba(14,17,22,0.09)"
            strokeWidth="0.8"
            fill="none"
          />
        </pattern>
        <pattern id="home-tile" width="16" height="16" patternUnits="userSpaceOnUse">
          <rect width="16" height="16" fill="#e3ebf4" />
          <path d="M0 0H16M0 0V16" stroke="rgba(14,17,22,0.1)" strokeWidth="0.8" fill="none" />
        </pattern>
        ...
        return (
          <g key={i}>
            <path
              ...
              strokeDasharray="2 2"
            />
            <line x1={hinge.cx} y1={hinge.cy} x2={open.cx} y2={open.cy} stroke="#97a2ae" strokeWidth={4.5} strokeLinecap="round" />
...
export function HomeStructures({ bounds }: { bounds: MapBounds }) {
  return (
    <g>
      <g filter="url(#home-blur)" fill="rgba(5,7,10,0.24)">
        {SHADOWED.map((b, i) => (
