...
with sync_playwright() as p:
    ...
    expect(phone.locator('#spoken')).to_contain_text('Thank you for telling me, Arthur')
    ...
    expect(phone.locator('#spoken')).to_contain_text("I'm Lantern")
    phone.locator('#reply').fill('I need help')
    phone.locator('#send-reply').click()
    expect(caregiver.locator('#attention')).to_be_visible()
    expect(phone.locator('#spoken')).to_contain_text('caregiver to review')
